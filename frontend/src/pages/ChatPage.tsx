  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-5">
      <div>
        ...
        <h2 className="mt-2 text-4xl font-black md:text-5xl">Resenha do bolao</h2>
        <p className="mt-3 text-sm text-black/55">
          Mensagens ficam visiveis apenas para o seu grupo e sao apagadas todos os dias.
        </p>
      </div>
      ...
      <section className="panel overflow-hidden rounded-[2rem]">
        <div className="flex flex-col gap-3 border-b border-black/8 p-5 md:flex-row md:items-center md:justify-between">
          <div>
            <strong className="block">{chat.data?.selected_group?.name ?? "Seu grupo"}</strong>
            <small className="text-black/45">Chat de hoje: {chat.data?.chat_date ?? "..."}</small>
          </div>
