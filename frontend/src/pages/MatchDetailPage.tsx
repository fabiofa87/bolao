            ...
            <div>
              {hasStarted ? (
                <>
                  ...
                  <p className="mt-1 text-sm text-black/55">
                    A partida comecou, entao os palpites foram liberados.
                  </p>
                ...
                <>
                  ...
                  <p className="mt-1 text-sm text-black/55">
                    O prazo de edicao encerrou. Os palpites dos outros participantes serao liberados no inicio da partida.
                  </p>
